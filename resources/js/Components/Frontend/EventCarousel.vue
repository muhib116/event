        ...
        <div class="container">
            ...
            <div class="main-content relative">
                ...
                <div class="absolute top-1/2 transform -translate-y-10 flex gap-2 w-full justify-between pointer-events-none">
                    <button @click="myCarousel.prev()" class="pointer-events-auto px-[12px] py-2 rounded bg-[#4f4cee] text-white">
                    ...
                    <button @click="myCarousel.next()" class="pointer-events-auto px-[12px] py-2 rounded bg-[#4f4cee] text-white">
