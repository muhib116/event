...
<head>
    ...
    <title>Wvent withdraw notice</title>
    @php
        $site_settings = \App\Models\SiteSetting::where('name', 'logo_image')->first();
    @endphp
</head>
                        ...
                        <tr>
                            <td class="header"
                                ...
                                <a target="_blank" rel="noopener noreferrer" href="{{ route('home') }}"
                                    ...
                                    <img src="{{ asset($site_settings->value) }}" class="logo" alt="Logo"
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td
                                                                                                ...
                                                                                                Your event <span style="color: #006584;">{{ $event->name }}</span> is closed.
                                                                                                You can withdraw after {{ \Carbon\Carbon::parse($event->end_date)->addDays(7)->format('d-M-Y') }}
                                                                                                <div>
